...
enum Cli {
    ...
    BuildWasi {
        ...
        #[arg(long)]
        release: bool,
        /// Root the export set at `build.minimal` (repo-root allowlist) and
        /// install to dist/occt-wasm-minimal.wasm.br instead of crate/src/ —
        /// dead-code elimination drops everything unreachable (STEP, XCAF,
        /// glTF, HLR, ...).
        #[arg(long)]
        minimal: bool,
    },
